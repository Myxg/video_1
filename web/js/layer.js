...
! function(e, t) {
    ...
    r.prompt = function(e, t) {
        ...
        var s, l = 2 == e.formType ? '<textarea class="layui-layer-input"' + a + ">" + (e.value || "") + "</textarea>" : function() { return '<input type="' + (1 == e.formType ? "" : "text") + '" class="layui-layer-input" value="' + (e.value || "") + '">' }(),
            f = e.success;
